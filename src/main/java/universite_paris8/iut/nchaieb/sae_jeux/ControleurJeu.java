...
public class ControleurJeu implements Initializable {
            ...
            stackPane.setOnMouseClicked(event -> {
                ...
                if (artefactSelectionne != null) {
                    ...
                    if (tourCliquee != null) {
                        ...
                        if (equipe) { // Si la tour l'accepte
                            environnement.getInventaire().retirerArtefact(artefactSelectionne);
                            artefactSelectionne = null; // On vide la main
    ...
    public void boutonGererPages(ActionEvent event){
        ...
        switch (this.page) {
            ...
            case 3: this.interfaceVue.animationLivrepage(this.crystal, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 4: this.interfaceVue.animationLivrepage(this.note, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 5: this.interfaceVue.animationLivrepage(this.croix, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 6: this.interfaceVue.animationLivrepage(this.eclipse, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 7: this.interfaceVue.animationLivrepage(this.triangle, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 8: this.interfaceVue.animationLivrepage(this.tomoe, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 9: this.interfaceVue.animationLivrepage(this.corne, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 10: this.interfaceVue.animationLivrepage(this.feu, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 11: this.interfaceVue.animationLivrepage(this.gouttedeau, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 12: this.interfaceVue.animationLivrepage(this.flocon, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
            case 13: this.interfaceVue.animationLivrepage(this.spirale, this.boutonOuvrirLivre, this.symbolesPageSuivante); break;
        }
