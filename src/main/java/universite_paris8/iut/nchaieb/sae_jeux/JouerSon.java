...
public class JouerSon {
    ...
    {
        // 1. Correctly assign to your class's static variable
        filePath = path;

        // 2. Create a File object from the path
        File audioFile = new File(filePath);

        // 3. Get the AudioInputStream using the file's absolute path
        ...
        // If you want it to loop automatically upon creation:
        if(count<1000){
            clip.loop(count);
        }
        else {
